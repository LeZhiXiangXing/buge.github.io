...
const tags = ["习惯", "助眠", "早起", "冥想", "正念", "瑜伽"];

export default defineConfig({
  title: "步鸽",
  description: "步鸽幸福生活每一天",
  head: [
    // 站点图标
    ...
    [
      ...
      `
        ...
        (function() {
          ...
          hm.src = "https://hm.baidu.com/hm.js?36257faac90dac49a4d5152bf5c91480";
  ...
  plugins: [
    ...
    [
      ...
      {
        ga: "G-91JSYJ2DNH", // 补充自己的谷歌分析 ID，比如 UA-00000000-0
      },
    ],
